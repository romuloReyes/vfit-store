      ...
      <section className="">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl">Vfit - Store</h1>
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">Vence tus limites</p>
            <button 
              ...
              <ul className="grid grid-cols-2 gap-4">
                {
                  products && products.length ? 
                    ...
                    products.filter( item => item.onSale === 'yes' ).splice( 0,2 ).map( productItem => (
                      <li className="cursor-pointer" key={productItem._id} onClick={()=> router.push(`/product/${productItem._id}`)}>
                        <div>
        ...
        <div className="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
                <div className="text-center">
                  <h2 className="text-xl font-bold text-gray-950 sm:text-3xl">Ordenar por Categoria</h2>
                </div>
                  ...
                  <li>
                    <div className="relative block group">
                      ...
                      <div className="absolute inset-0 flex flex-col items-start justify-end p-6">
                        <h3 className="text-xl font-medium text-white">Otros Articulos</h3>
                        <button 
